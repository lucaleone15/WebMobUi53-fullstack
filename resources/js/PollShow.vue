...
<template>
    <div class="min-h-screen bg-gray-50 px-4 py-12">
        <div class="mx-auto max-w-2xl">
            ...
            >
                <p class="mb-4 text-2xl font-bold text-red-600">Attention</p>
                ...
                <div class="p-8">
                    ...
                    >
                        <p class="font-medium text-gray-600">
                            Les résultats seront disponibles une fois que vous
                            aurez voté ou que le sondage sera terminé.
                        </p>
                        <a
                            v-if="loginUrl && showVotingForm"
                            :href="loginUrl"
